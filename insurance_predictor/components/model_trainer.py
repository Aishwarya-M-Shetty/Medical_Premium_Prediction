from insurance_predictor.entity import artifact_entity,config_entity
    ...
    def initiate_model_trainer(self,)->artifact_entity.ModelTrainerArtifact:
        try:
            ...
            if r2_test_score<self.model_trainer_config.expected_score:
                logging.info(f"Model is not good as it is not able to give expected accuracy: {self.model_trainer_config.expected_score}: model actual score: {r2_test_score}")
                #raise Exception(f"Model is not good as it is not able to give expected accuracy: {self.model_trainer_config.expected_score}: model actual score: {r2_test_score}")
